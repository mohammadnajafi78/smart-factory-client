...
export default function NewProductType({
  ...
  useEffect(() => {
    httpService
      .get(
        `${API_BASE_URL}/api/management/product/category/category_title_list/`
      )
      .then(res => {
        if (res.status === 200) {
        ...
        content={
          <Formik
            initialValues={{
              ...
              category: type === 'edit' ? data.category_detail.id : '',
            ...
            onSubmit={(values, { setErrors, setSubmitting }) => {
              ...
              if (type === 'new') {
                ...
                httpService
                  .post(
                    `${API_BASE_URL}/api/management/product/subcategory/add_subcategory/`,
                    formData
                  )
                  .then(res => {
                    if (res.status === 201) {
                ...
                httpService
                  .patch(
                    `${API_BASE_URL}/api/management/product/subcategory/${data.id}/`,
                    formData
                  )
                  .then(res => {
                    if (res.status === 200) {
                  ...
                  <Grid xs={6} item>
                    ...
                    {subCategory.length > 0 && (
                      <Autocomplete
                        ...
                        options={subCategory}
                        value={
                          subCategory.filter(f => f.id === values.category)[0]
                        }
                        ...
                        onChange={(event, newValue) => {
                          ...
                          if (newValue) setFieldValue('category', newValue.id);
                        }}
