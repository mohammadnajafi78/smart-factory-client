...
const ReceiveTable = props => {
  ...
  //   httpService
  //     .get(
  //       `${API_BASE_URL}//api/management/project/get_receive_request?type=WARRANTY&limit=10&offset=0`
  //     )
  //     .then(res => {
  //       if (res.status === 200) {
  ...
  function getData(page, rowsPerPage, search) {
    httpService
      ...
      .post(
        `${API_BASE_URL}/api/management/project/get_receive_request/?type=WARRANTY&limit=${rowsPerPage}&offset=${page *
