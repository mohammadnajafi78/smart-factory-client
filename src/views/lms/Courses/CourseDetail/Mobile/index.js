...
export default function CourseDetailMobile(props) {
    ...
    <>
      ...
      >
        {courseDetail && (
          ...
          >
            <img src={courseDetail?.image?.url} />
            <Box
              sx={{
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <Box>
                              <InputLabel
                                style={{ color: '#00346D', fontSize: '13px' }}
                              >
                                {item?.name}
                              </InputLabel>
                              <InputLabel
                                style={{
                                  ...
                                  color: JSON.parse(item?.status?.data).text,
                                  fontSize: '12px',
                                  padding: '3px 6px',
                                  width: 'fit-content',
                                  borderRadius: '4px'
