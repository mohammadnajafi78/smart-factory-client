    ...
    <>
      ...
      {data.current_state.name === 'WAITING_FOR_PAYMENT' && (
        ...
        >
          ...
          >
            {/* {location === 'payment' && <AcceptPayment data={data} {...props} />} */}
            ...
            {/* {payment && <AddPayment data={data} {...props} />} */}
          </Box>
        </Box>
      )}
      ...
      <CustomizedDialogs
        open={openPIApprove}
        title={'پیش فاکتور'}
        handleClose={() => setOpenPIApprove(false)}
        content={
          <Box
            sx={{
              display: 'flex',
      ...
      {openDeliveryInfo && (
        <CustomizedDialogs
          ...
          handleClose={() => setOpenDeliveryInfo(false)}
              ...
              <Box sx={{ width: '100%' }}>
                ...
                >
                  ...
                  >
                    ...
                    {data.files &&
                      data.files.length > 0 &&
                      data?.files.filter(f => f.subject === 'BL').length >
                        0 && (
                        <a
                          href={
